...
if __name__=="__main__":
    ...
    measured_pos, measured_acc, measured_time = Simulation.generate_nonlinear_measurements(sigma_acc=sigma_acc_continuous, pos_freq=laser_range_freq, acc_freq=imu_freq, meas_model=laser_range)
